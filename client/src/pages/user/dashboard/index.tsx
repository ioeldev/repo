    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-3 text-sm text-muted-foreground">
        ...
        <span className="font-medium">
          {formatAmount(balances.usdt, "USD")}
        </span>
      </div>
      <div className="flex gap-3 text-sm text-muted-foreground">
        <span>EUR:</span>
  ...
  const stats = [
    {
      title: "Trading",
      value: formatAmount(
        summary.trading.total_balance,
        sourceCurrency as "USD" | "EUR",
      ),
    ...
    },
    {
      title: "Investments",
      value: formatAmount(
        summary.investments.total_balance,
        sourceCurrency as "USD" | "EUR",
      ),
    ...
    },
    {
      title: "Performance",
      value: formatAmount(
        summary.portfolio.total_performance,
        sourceCurrency as "USD" | "EUR",
      ),
      icon: (
        <TrendingDown
          className={`h-5 w-5 ${
            summary.portfolio.total_performance >= 0
              ? "text-green-500"
              : "text-red-500"
          }`}
        />
  ...
  return (
    <div className="space-y-8 container max-w-full px-4 md:px-6 lg:px-8 py-6">
      ...
      <FullWidthStatCard
        title="Total Balance"
        value={formatAmount(
          summary.portfolio.total_balance,
          sourceCurrency as "USD" | "EUR",
        )}
