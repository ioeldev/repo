...
export function PositionsTable({ positions, isLoading = false }: PositionsTableProps) {
    ...
    const columns: ColumnDef<Position>[] = [
        ...
        {
            accessorKey: "type",
            header: t("user.positionsTable.type"),
            cell: ({ row }) => {
                ...
                return (
                    ...
                    >
                        {type === "buy" ? t("user.positionsTable.buy") : t("user.positionsTable.sell")}
                    </div>
                );
            },
        },
        {
            ...
            header: ({ column }) => (
                <Button
                    ...
                    className="h-8 p-0"
                >
                    {t("user.positionsTable.quantity")}
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                </Button>
            ),
            cell: ({ row }) => {
        ...
        },
        {
            ...
            header: ({ column }) => (
                <Button
                    ...
                    className="h-8 p-0"
                >
                    {t("user.positionsTable.entryPrice")}
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                </Button>
            ),
            cell: ({ row }) => {
        ...
        },
        {
            ...
            header: t("user.positionsTable.exitPrice"),
            cell: ({ row }) => {
        ...
        },
        {
            ...
            header: t("user.positionsTable.leverage"),
            cell: ({ row }) => {
        ...
        {
            accessorKey: "status",
            header: t("user.positionsTable.status"),
            cell: ({ row }) => {
                ...
                return (
                    ...
                    >
                        {status === "open" ? t("user.positionsTable.open") : t("user.positionsTable.closed")}
                    </div>
                );
            },
        },
        {
            ...
            header: ({ column }) => (
                <Button
                    ...
                    className="h-8 p-0"
                >
                    {t("user.positionsTable.entryTime")}
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                </Button>
            ),
            cell: ({ row }) => {
        ...
        },
        {
            ...
            header: t("user.positionsTable.exitTime"),
            cell: ({ row }) => {
            ...
            <Table>
                ...
                <TableBody>
                    {isLoading ? (
                        ...
                        <TableRow>
                            <TableCell colSpan={columns.length} className="h-24 text-center">
                                {t("user.positionsTable.noPositions")}
                            </TableCell>
                        </TableRow>
                    )}
                </TableBody>
