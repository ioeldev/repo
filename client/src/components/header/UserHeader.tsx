                                        ...
                                        <NavigationMenuItem key={item.title}>
                                            <NavigationMenuLink
                                                ...
                                                className={`group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-all ${
                                                    isActive(item.url) ? "text-text-link" : "text-muted-foreground"
                                                }`}
                                            >
                        ...
                        <div className="hidden lg:block">
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="gap-2 cursor-pointer hover:bg-background">
                        ...
                        <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                            ...
                            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                                ...
                                <div className="flex flex-col gap-6 py-6">
                                        ...
                                        {menuItems.map((item) => (
                                            <Link
                                                ...
                                                className={`rounded-md px-3 py-2 text-sm font-medium transition-colors ${
                                                    isActive(item.url) ? "text-text-link" : "hover:text-text-link"
                                                }`}
                                            >
                                                {item.title}
                                            </Link>
                                    ...
                                    {/* Mobile Theme Toggle */}
                                    <div className="flex flex-col gap-2">
                                        <p className="px-3 py-2 text-xs font-semibold text-muted">Theme</p>
                                        <div className="flex flex-col gap-1 px-3">
                                            <button
                                                onClick={() => setTheme("light")}
                                                className={`flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors ${
                                                    theme === "light" ? "text-text-link" : "hover:text-text-link"
                                                }`}
                                            >
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <p className="px-3 py-2 text-xs font-semibold text-muted">Currency</p>
                                        <div className="flex flex-col gap-1 px-3">
                                            <button
